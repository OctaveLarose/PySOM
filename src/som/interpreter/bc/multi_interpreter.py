...
def interpret(method, frame, max_stack_size):
    ...
    while True:
        ...
        if state == 0:
            execution_ctx.no_tos_caching = True # Obviously needs to be defined beforehand
            ...
            if bytecode == Bytecodes.dup:
                ...
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = read_frame(frame, FRAME_AND_INNER_RCVR_IDX + 0)

            elif bytecode == Bytecodes.push_frame_1:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = read_frame(frame, FRAME_AND_INNER_RCVR_IDX + 1)

            elif bytecode == Bytecodes.push_frame_2:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = read_frame(frame, FRAME_AND_INNER_RCVR_IDX + 2)
                ...
                execution_ctx.stack_ptr += 1
                if ctx_level == 0:
                    stack[execution_ctx.stack_ptr] = read_inner(frame, idx)
                else:
                ...
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = read_inner(frame, FRAME_AND_INNER_RCVR_IDX + 0)

            elif bytecode == Bytecodes.push_inner_1:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = read_inner(frame, FRAME_AND_INNER_RCVR_IDX + 1)

            elif bytecode == Bytecodes.push_inner_2:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = read_inner(frame, FRAME_AND_INNER_RCVR_IDX + 2)
                ...
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = BcBlock(block_method, get_inner_as_context(frame))
                ...
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = method.get_constant(current_bc_idx)

            elif bytecode == Bytecodes.push_constant_0:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = method._literals[0]  # pylint: disable=protected-access

            elif bytecode == Bytecodes.push_constant_1:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = method._literals[1]  # pylint: disable=protected-access

            elif bytecode == Bytecodes.push_constant_2:
                execution_ctx.stack_ptr += 1
                stack[execution_ctx.stack_ptr] = method._literals[2]  # pylint: disable=protected-access
                ...
                execution_ctx.stack_ptr = _do_super_send(current_bc_idx, method, stack,
                                                              execution_ctx.stack_ptr)
